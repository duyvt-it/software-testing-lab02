...
WebUI.waitForElementPresent(findTestObject('TC005_SuccessLogin/Page_CURA Healthcare Service/h2_Make Appointment'), 10)

WebUI.verifyElementText(findTestObject('Object Repository/TC005_SuccessLogin/Page_CURA Healthcare Service/h2_Make Appointment'), 
    'Make Appointment')
